...
public class CheckoutOverviewTest extends BaseTest {
    ...
    @Test
    public void verifyUICheckoutOverview() {
        ...
        WebElement textQty = driver.findElement(CheckoutOverviewPageUI.TEXT_QTY);
        ...
        WebElement textDesc = driver.findElement(CheckoutOverviewPageUI.TEXT_DESCRIPTION);
        ...
        Assert.assertTrue(checkoutOverviewPage.isCartBadgeDisplayed(), "Giỏ hàng không hiển thị");
        Assert.assertEquals(checkoutOverviewPage.getCartBadgeCount(), "2", "Số lượng giỏ hàng không khớp");
