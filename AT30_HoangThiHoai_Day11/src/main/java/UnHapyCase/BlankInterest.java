...
public class BlankInterest {
    static void main(String[] args) throws InterruptedException {
        ...
        elementPhone.sendKeys("34654768");
        ...
        selectInterest.selectByVisibleText("Select...");
        ...
        WebElement elementRequiedInterest = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='ValidMsgSolution_Interest__c']")));
        String KQMMRequieInterest = "This field is required.";
        if (elementRequiedInterest.getText().equals(KQMMRequieInterest)) {
