...
public class InvalidPostFixEmail {
    static void main(String[] args) throws InterruptedException {
        ...
        //Case: nhập hậu tố sai định dạng
        ...
        elementEmail.sendKeys("hoai@gmail.com");
        ...
        WebElement elementRequiedEmailRow=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='ValidMsgEmail']")));
        String KQMMRequiedEmailRow = "Enter valid business email address";
