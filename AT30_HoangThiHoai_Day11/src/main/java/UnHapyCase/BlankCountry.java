...
public class BlankCountry {
    static void main(String[] args) throws InterruptedException {
        ...
        WebElement elementRequiedCountry = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='ValidMsgCountry']")));
        String KQMMRequieCoutry = "This field is required.";
        if (elementRequiedCountry.getText().equals(KQMMRequieCoutry)) {
