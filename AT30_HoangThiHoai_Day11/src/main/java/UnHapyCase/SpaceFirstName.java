...
public class SpaceFirstName {static void main(String[] args) throws InterruptedException {
    ...
    //Case:fristName nhập khoảng trắng
    ...
    WebElement elementRequiedFristName=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//div[@id='ValidMsgFirstName']")));
    String KQMMRequiedFristName = "This field is required.";
    if (elementRequiedFristName.getText().equals(KQMMRequiedFristName)) {
